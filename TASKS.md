...
- [x] Create fake-angular-app-base/ — base state fixture; update fake-angular-app/ to represent the after state with meaningful differences (added files, modified files, changed imports, new out-of-scope deps)
- [x] Integration tests: run full pipeline with --base-dir fake-angular-app-base, verify node diff states and edge diff states
...
- [x] Tests: src/renderer/draw.test.ts — node color selection, edge path generation, label truncation
